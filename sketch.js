  ...
  function setup() {
    ...
    ground1 = new Box(1200,480,290,12,"red");
    ground2 = new Box(700,300,290,12,"blue");
    ground3 = new Box(750,595,1500,10,"green");
...
/*
    ...
    in Sling class
    rope = new Sling(polygon.body,{x:190,y:490});
*/
  ...
  function draw() {
    ...
    */
    ...
    Matter.Body.setStatic(ground2.body,true);
    Matter.Body.setStatic(ground3.body,true);
